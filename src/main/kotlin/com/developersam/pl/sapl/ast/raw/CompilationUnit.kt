 ...
 * It refers to a source code file, which contains some [imports] and a module [module].
 * During compilation, this node is used only temporarily as a tool for dependency analysis.
 */
internal data class CompilationUnit(val imports: Set<String>, val module: Clazz)
