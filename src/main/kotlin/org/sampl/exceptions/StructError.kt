...
sealed class StructError(reason: String) : CompileTimeError(reason = reason) {
     ...
     * member.
     */
    class MissingMember internal constructor(
            lineNo: Int, structName: String, missingMember: String
     ...
     */
    class NoSuchMember internal constructor(lineNo: Int, structName: String, memberName: String) :
     ...
     */
    class NotFound internal constructor(lineNo: Int, structName: String) :
